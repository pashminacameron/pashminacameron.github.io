...
.. image:: images/cpp-compilers-comparison.png
    :width: 800px
    :align: center
    :alt: alternate text
...
.. image:: images/cpp-avx-compilers-comparison.png
    :width: 800px
    :align: center
    :alt: alternate text
...
.. image:: images/cpp-avx-compilers-comparison-all.png
    :width: 800px
    :align: center
    :alt: alternate text
...
- C++ with auto-vectorization is closer to AVX from GCC 6 onwards. All C++ lines are with :code:`-ffast-math` flag. Without it, the results are worse.
